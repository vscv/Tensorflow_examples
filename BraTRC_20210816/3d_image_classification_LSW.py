...
##CK
## batch=2, prefetch=2, must has 4 examples for train/valid.
...
#    desired_height = 64
    ...
    #CK
#    print("# resize to w{}xh{} x d{}".format(desired_width,desired_height,desired_depth))
...
normal_scan_paths = [
    os.path.join(os.getcwd(), "MosMedData_org/CT-0", x)
    for x in os.listdir("MosMedData_org/CT-0")
]
# Folder "CT-23" consist of CT scans having several ground-glass opacifications,
# involvement of lung parenchyma.
abnormal_scan_paths = [
    os.path.join(os.getcwd(), "MosMedData_org/CT-23", x)
    for x in os.listdir("MosMedData_org/CT-23")
]
...
##CK the ds was changed to 40/40, split to train/valid to 30:10, 40 examples take ~75 sec.
## Split data in the ratio 70-30 for training and validation.
