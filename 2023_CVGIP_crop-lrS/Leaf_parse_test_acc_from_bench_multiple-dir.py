...
# 2022-02-24
#
# parse multiple directories in same time.
#
#
#
# ==============================================================================
"""
python3 Leaf_parse_test_acc_from_bench_dir.py 0 12 imagenet1k crop plateau RA 512 512
...
cd tf.ds.pipeline;
echo "nv2111testacc";
sh Leaf_parse_test_acc_from_bench_dir.sh;
"""
