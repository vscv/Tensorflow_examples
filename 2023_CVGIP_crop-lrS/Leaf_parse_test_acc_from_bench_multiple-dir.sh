...
#
# nv2111testaccall
# echo "nv2111testaccall"; cd tf.ds.pipeline; sh Leaf_parse_test_acc_from_bench_multiple-dir.sh;
##################################################################################################
...
train_cmd="python3 Leaf_parse_test_acc_from_bench_multiple-dir.py"
