...
# # 2023-06-26 JQ This is older version of tf keras api # #
#from tensorflow.python.keras.layers.preprocessing import image_preprocessing as image_ops
#from tensorflow.keras.preprocessing import image as image_ops
#from keras.utils import image_utils as image_ops
import keras.utils as image_ops
...
def transform(image: tf.Tensor, transforms) -> tf.Tensor:
  ...
  image = to_4d(image)
  image = image_ops.apply_affine_transform(
