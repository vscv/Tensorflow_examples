...
[2022-02-15]
    ...
    2. Using SavedModel rather than keras hd5f
...
#                    build_tf_hub_models()
#            """
#            if model_name in ['MobileNetV2', 'MobileNetV3Small', 'MobileNetV3Large', 'DenseNet121', 'DenseNet169', 'DenseNet201', 'VGG16', 'VGG19']:
#                print('\n\n* * * Building keras.apps...\n\n')
...
#
#
#        # SavedModel : backup a SavedModel to compare the size of hd5f
#        # Note that: this save is not the best model but the latest model.
#        # the SavedModel size is same as hd5f in VGG16/19
#        # VGG16 hd5f 176.7MB SaveModel 177.3MB
#        # VGG19 hd5f 240.55MB SavedModel 241.2MB
#        # EfficientNetV2B2 hd5f 105.9MB SavedModel 112.5MB
#        # NASNetMobile hd5f 54.0MB SavedModel 78.7MB
...
#        bench_log_name = f'./{log_dir_name}/{model_name}/{model_name}_{N}_{weight}_{crop}_{img_width}x{img_height}_{lr_name}_{augment}_bs{MULTI_BATCH_SIZE}_best_{monitor}.npy'
...
#        pgn=f'./{log_dir_name}/{model_name}/{model_name}_{N}_{weight}_{crop}_{img_width}x{img_height}_{lr_name}_{augment}_bs{MULTI_BATCH_SIZE}_best_{monitor}_hisnpTL_loss.png'
...
#        pgn=f'./{log_dir_name}/{model_name}/{model_name}_{N}_{weight}_{crop}_{img_width}x{img_height}_{lr_name}_{augment}_bs{MULTI_BATCH_SIZE}_best_{monitor}_hisnpTL_val_acc.png'
#        print(f'Save to {pgn} \n')
#        plt.savefig(pgn, bbox_inches = 'tight', dpi=dpi)
#
#
...
#        pgn=f'./{log_dir_name}/{model_name}/{model_name}_{N}_{weight}_{crop}_{img_width}x{img_height}_{lr_name}_{augment}_bs{MULTI_BATCH_SIZE}_best_{monitor}_hisnpTL_val_acc_lr.png'
#        print(f'Save to {pgn} \n')
#        plt.savefig(pgn, bbox_inches = 'tight', dpi=dpi)
#
#
...
#        pgn=f'./{log_dir_name}/{model_name}/{model_name}_{N}_{weight}_{crop}_{img_width}x{img_height}_{lr_name}_{augment}_bs{MULTI_BATCH_SIZE}_best_{monitor}_hisnpTL_val_acc_lr_cyc.png'
#
#        print(f'Save to {pgn} \n')
#        plt.savefig(pgn, bbox_inches = 'tight', dpi=dpi)
#
...
#
#        max_val_acc_name=f'./{log_dir_name}/{model_name}/{model_name}_{v_a[b_e]}_{N}_{b_e}e.vacc'
