...
#
#    2022-02-22
#    rewrite to show base_model's input size and the parameters.
#         
#         
"""
python3 2022_Leaf_rewrite-for-model-benchmark-forConvert2Py_base_model_size_parameters.py 33 34 imagenet1k crop plateau RA 512 512 1


hub cache model:"/tmp/tfhub_modules/d30c685f31c2a953a48eeb6695c0f7a77298ea8b/"

    WARNING:tensorflow:SavedModel saved prior to TF 2.5 detected when loading Keras model. Please ensure that you are saving the model with model.save() or tf.keras.models.save_model(), *NOT* tf.saved_model.save(). To confirm, there should be a file named "keras_metadata.pb" in the SavedModel directory.
    Traceback (most recent call last):
      File "2022_Leaf_rewrite-for-model-benchmark-forConvert2Py_base_model_size_parameters.py", line 735, in <module>
        print(hub_model.summary())
    
    [tf hub model cache can not be used like that] maybe load from fine tune
...
for model_name in Model_List:
    ...
    #     unfreeze_model(model_toe,base_model) # skip the TL so unfreeze when build_EFN()
        ...
        #
        #
        # hub keras layer no summary, and seems can not display the detailed layers.
        # even, we try to save/load from cache, save not works
        #
        
        #print(base_model.summary()) ##AttributeError: 'KerasLayer' object has no attribute 'summary'
        
#        #print("hub config:", base_model.get_config())
#        hub_model = tf.keras.models.load_model("/tmp/tfhub_modules/d30c685f31c2a953a48eeb6695c0f7a77298ea8b/")
#        #print(hub_model.summary())
#        #hub_model.save('/tmp/model')
#        #loaded_hub_model = tf.keras.models.load_model('/tmp/model')
#        #print(hub_model.summary())
#
#        #hub_model = tf.saved_model.load("/tmp/tfhub_modules/d30c685f31c2a953a48eeb6695c0f7a77298ea8b/")
#        #print("hub config:", hub_model.get_config()) #AttributeError: '_UserObject' object has no attribute 'get_config'
#
#        hub_model.save('/tmp/savetokerasmodel')#AttributeError: '_UserObject' object has no attribute 'save'
#        base_model.save('/tmp/savetokerasmodel')#AttributeError: 'KerasLayer' object has no attribute 'save'
#
#        loaded_hub_model = tf.keras.models.load_model('/tmp/savetokerasmodel')
#
#        print(loaded_hub_model.summary()) ## print will added a 'None' of end of summary().
        ...
        with open('modelsummary.txt','w') as fh:
            ...
            model_toe.summary(print_fn=lambda x: fh.write(x + '\n'))
    
        stringlist = []
        model_toe.summary(print_fn=lambda x: stringlist.append(x))
        short_model_summary = "\n".join(stringlist)
        print(short_model_summary)
        
        # or
#        summary = str(model_toe.to_json())
#        print('json model', summary)
        
#        for line in short_model_summary:
#            #if line.startswith('Total params:'):
#            print("Total params:", str(line))
        
        #print(model_toe.summary())
        
        #ft_model_sum = f'{model_toe.summary()}'
        #print(ft_model_sum[::-3])
